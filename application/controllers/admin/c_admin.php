...
class c_admin extends CI_Controller
{
    ...
    public function insertproduct() 
    {
        ...
        $this->load->view('templates/admin/footer');
        $this->load->view('templates/admin/sidebar');
        $this->load->view('templates/admin/insertproduct');
        if($this->input->post('submit') != NULL ) {
            $arr_product=$this->input->post();
            $arr_product['image']=$this->do_upload();
            $this->load->model('admin/m_admin');
            $this->m_admin->insertproduct($arr_product);
        }
    }
    ...
    public function delete($id)
    {
        ...
        $this->load->view('templates/admin/header');
        $this->load->view('templates/admin/sidebar');
        $this->load->view('templates/ad min/productlist',$data);
        $this->load->view('templates/admin/footer');
    }
    ...
    public function deletecategory($id)
    {
        ...
        $this->load->view('templates/admin/headeradminLTE');
        $this->load->view('templates/admin/sidebarLTE');
        $this->load->view('templates/adm in/categorylist',$data);
        $this->load->view('templates/admin/footeradminLTE');
    }
    public function update($id){
        ...
        $this->load->view('templates/admin/foo ter');
        if($this->input->post('submit') != NULL) {
              $arr_product=$this->input->post();
            $this->load->model('admin/m_admin');
    ...
    public function updatecategory($id){
        ...
        $this->load->view('templates/admin/headeradminLTE');
        $this->load->view('templates/admin/sidebarLTE');
        $this->load->view('templates/admin /update category',$sdata,$data);
        $this->load->view('templates/admin/footeradmin LTE');
        if($this->input->post('submit') != NULL) {
              $arr_product=$this->input->post();
            $this->load->model('admin/m_admin');
