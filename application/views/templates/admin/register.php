...
<body class="animsition">
		...
		<div class="container-menu-header">
			...
			<div class="wrap_header">
				...
				<div class="header-icons">
					<a href="?controller=dangnhap&action=login" class="header-wrapicon1 dis-block">
							...
							<ul class="header-cart-wrapitem">
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="public/public/images/item-cart-01.jpg" alt="IMG">
									</div>
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(public/images/pexels-photo-1345082.jpeg);">
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(public/images/pexels-photo-1345082.jpeg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(public/images/pexels-photo-1345082.jpeg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
	...
	<form action="?controller=dangnhap&action=sendRegister" method="post" style="background-color: #d8d8d8;padding: 30px;">
		<h2>Đăng ký thành viên</h2>
		Username:<br />
		<input type="text" name="username"><br />
		Password:<br />
		<input type="text" name="password"><br /><br />
		<input type="submit" value="Đăng ký" style="background-color: gray; width: 5%">
	</form>
